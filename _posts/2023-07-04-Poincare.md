...
&=|B_R|^{\frac{1}{dq}}|B_R|^{\frac{q-1}{dq}}\left(\frac{1}{w(B_R)} \int_{B_R} w dx \right)^{\frac{1}{dq}} \left( \frac{1}{w(B_R)} \int_{B_R} w^{-\frac{1}{q-1}} dx \right)^{\frac{q-1}{dq}}\\
&\leq NR [w]_{A_q}^{1/(dq)}.
\end{align}
This implies that 
\begin{align}
...
$$ \frac{1}{w(B_R)} \int_B |\varphi(x)-\varphi(y)|dy \leq N \int_B \frac{|\nabla \varphi|}{|x-y|^{d-1}}dy$$
...
$$
|\varphi(x)-\gamma|\leq \frac{1}{w(B_R)} \int_B |\varphi(x)-\varphi(y)| dy \leq N \int_{B} \frac{|\nabla \varphi|}{|x-y|^{d-1}} dy.
$$
Hence it follows from the mapping of Riesz potentials that 
\begin{align}
\left(\frac{1}{w(B)} \int_B |\varphi-\gamma|^{kp} dx\right)^{1/kp}&\leq N \left(\frac{1}{w(B_R)} \int_{B} |I[\nabla \varphi]|^{kp} wdx\right)^{1/kp}\\
&\leq N r \left(\frac{1}{w(B_R)} \int_{B} |\nabla \varphi |^p w dx\right)^{1/p}.
\end{align}
Then the desired result follows from Jensen's inequality. 

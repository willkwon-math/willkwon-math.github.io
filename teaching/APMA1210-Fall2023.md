...
- [RAND cooperations reports](https://www.rand.org/pubs/papers/P936.html)
  - You can find several reports from this website which becomes public.
  - One example that I found is an application of linear programming to solve "month-to-month airlift planning within the U. S. Military Air Transport Service (MATS)".
